...
try:
  from aruba import aruba_pipeline as aruba
  from . import valve_acl
  from . import valve_flood
  from . import valve_host
  from . import valve_of
  from . import valve_packet
  from . import valve_route
  from . import util
except:
...
class Valve(object):
    ...
    def datapath_connect(self, dp_id, discovered_up_port_nums):
        ...
        changed_vlans = iter(self.dp.vlans.keys())
